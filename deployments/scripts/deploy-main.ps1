...
Write-Host "- Region: $AZURE_LOCATION"
...
(Get-Content $workflowFile -Raw) -replace '@\{parameters\(''apiKey''\)\}', $env:AZURE_AI_API_KEY | Set-Content $tempWorkflow
